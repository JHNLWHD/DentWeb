...
<body>
 ...
 <form  action="addmedicinedb" method="POST">
            <h1> Add Medicine </h1>
				   		...
				   		<!--use this grid system to center.-->
				     		...
				     		<div class="form-group ">
				        		...
				        		*
				      			...
				      			<input class="form-control" id="genericname" name="genericname" type="text"/>
				     		</div>
				     		<div class="form-group ">
				     		...
				     		<div class="form-group ">
				      			...
				      			<input class="form-control" id="unitdosage" name="unitdosage" type="text"  pattern=".{1,4}" required title="Either 1 to 4 chars" onkeydown="return ( event.ctrlKey || event.altKey 
